...
class _WaitEmailCard extends StatefulWidget {
  const _WaitEmailCard({
    super.key,
  ...
  @override
  _WaitEmailCardState createState() => _WaitEmailCardState();
}

class _WaitEmailCardState extends State<_WaitEmailCard>
  ...
  Widget _buildResendCode(ThemeData theme, LoginMessages messages) {
    return ScaleTransition(
      ...
      child: AnimatedButton(
        ...
        text: messages.resendCodeButton,
            ...
            child: Column(
              children: <Widget>[
                ScaleTransition(
                  scale: widget.loadingController,
                  child: Text(
                    messages.waitEmailVerificationIntro,
